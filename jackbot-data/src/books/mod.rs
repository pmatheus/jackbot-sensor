...
/// Enhanced order book analytics with depth analysis and market insights.
pub mod analytics;
...
#[derive(
    Debug, Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, Deserialize, Display, Default,
)]
pub struct Bids;
...
// Re-export microstructure types for convenience
pub use microstructure::{MarketMicrostructureAnalyzer, MicrostructureMetrics, OrderBookSnapshot};
// Re-export analytics types for convenience
pub use analytics::{
    AnalyticsSummary, BookAnalyticsData, DepthMetrics, OrderBookAnalytics, VolumeProfile,
};
