use jackbot_data::exchange::gateio::rate_limit::GateioRateLimit;
use jackbot_integration::rate_limit::Priority;
use tokio::time::{Duration, Instant};

#[tokio::test]
async fn test_rest_limit_exhaustion() {
    let rl = GateioRateLimit::with_params(1, Duration::from_millis(10), 1, Duration::from_millis(10), Duration::from_millis(0));
...
async fn test_ws_backoff_jitter() {
    let rl = GateioRateLimit::with_params(1, Duration::from_millis(5), 1, Duration::from_millis(5), Duration::from_millis(5));
