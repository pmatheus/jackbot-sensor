...
pub use jackbot_instrument::Side;
...
/// Sensor-specific order types and implementations.
///
/// High-performance order types: Jackpot, Prophetic, and Event-triggered orders.
pub mod sensor;

pub mod intelligent_router;
/// Order routing and exchange selection.
///
/// Multi-exchange routing with latency optimization and risk management.
pub mod router;

/// Concurrent order execution engine.
///
/// High-performance executor with sensor-specific order processing.
pub mod executor;

/// Real-time analytics and performance monitoring.
///
/// Comprehensive metrics and monitoring for sensor order execution.
pub mod analytics;
...
pub enum OrderKind {
    ...
    Stop,
    StopLimit,
    /// Sensor-specific order types for high-performance trading
    Jackpot,
    Prophetic,
    EventTriggered,
}
