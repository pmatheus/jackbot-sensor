//! Gate.io execution client implementation.
//!
//! This client provides basic trading functionality for Gate.io spot markets.
...
/// Configuration for Gate.io client.
#[derive(Clone, Debug)]
        ...
        crate::order::OrderEvent {
            ...
            state: Err(UnindexedOrderError::Connectivity(
                crate::error::ConnectivityError::Socket(
                    "Gate.io cancel_order not yet implemented".to_string(),
                ),
            )),
        }
    }
